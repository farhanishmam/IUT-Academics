...
WHERE ORDERS.ORDER_ID = ORDER_ITEMS.ORDER_ID AND STATUS = 1 AND ORDER_DATE = in_year;
--SUM(quantity) will also be accepted. And it kind of makes sense to use SUM(quantity) instead of count. 
